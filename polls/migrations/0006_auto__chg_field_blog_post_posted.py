...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blog_Post.posted'
        db.alter_column(u'polls_blog_post', 'posted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Blog_Post.posted'
        db.alter_column(u'polls_blog_post', 'posted', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
