...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'Blog_Post', fields ['posted']
        db.delete_index(u'polls_blog_post', ['posted'])


    def backwards(self, orm):
        # Adding index on 'Blog_Post', fields ['posted']
        db.create_index(u'polls_blog_post', ['posted'])
    ...
    models = {
        ...
        u'polls.blog_post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['photologue.Photo']", 'symmetrical': 'False', 'blank': 'True'}),
